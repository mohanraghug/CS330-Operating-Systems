...
#define SYSCALL_COUNT_BREAKPOINTS     42
#define SYSCALL_CHECK_ENABLED_BREAKPOINTS    43
...
extern int count_breakpoints(void *addr);
extern int check_enabled(void *addr);
