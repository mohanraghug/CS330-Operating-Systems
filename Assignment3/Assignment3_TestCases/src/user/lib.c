...
int count_breakpoints(void *addr)
{
	return _syscall1(SYSCALL_COUNT_BREAKPOINTS, (u64)addr);	
}

int check_enabled(void *addr)
{
	return _syscall1(SYSCALL_CHECK_ENABLED_BREAKPOINTS, (u64)addr);
}
