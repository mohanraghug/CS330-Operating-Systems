/* This test case is to check lseek implementation for SEEK_SET whence*/
...
int main(u64 arg1, u64 arg2, u64 arg3, u64 arg4, u64 arg5)
{
    ...
    int val = lseek(create_fd,0,SEEK_SET);
    ...
    val = lseek(create_fd,tot_bytes,SEEK_SET);

    readr = read(create_fd,&buf1[29],29);
