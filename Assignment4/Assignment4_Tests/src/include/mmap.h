...
// page table helper functions related to huge pages
// has to be removed when we release
extern u64* get_pmd_entry(struct exec_context *ctx, u64 addr, int dump); 
extern int invalidate_pmd_entry(struct exec_context *ctx, unsigned long addr, u32 is_hugepage);
extern void install_hugepage_entry(struct exec_context *ctx, u64 addr, u64 pfn, u64 ac_flags); 
extern void install_normal_entry(struct exec_context *ctx, u64 addr, u64 normal_page_pfn, u64 ac_flags); 
